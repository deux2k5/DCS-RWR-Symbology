...
rwr_codes["QF-4E"] = { code = "F4", coal = 1, desc = "APQ-120" }
...
rwr_codes["F-14BU"] = { code = "14", coal = 1, desc = "AWG-9" }
rwr_codes["F-14A-95-GR"] = { code = "14", coal = 1, desc = "AWG-9" }
rwr_codes["F-14A-135-GR-Early"] = { code = "14", coal = 1, desc = "AWG-9" }
...
rwr_codes["Mirage-F1AD"] = { code = "M1", coal = 1, desc = "Cyrano IV" }
rwr_codes["Mirage-F1AZ"] = { code = "M1", coal = 1, desc = "Cyrano IV" }
rwr_codes["Mirage-F1JA"] = { code = "M1", coal = 1, desc = "Cyrano IV" }
...
rwr_codes["Gepard"				] = { code = "GP", coal = 1, desc="MPDR-12" }
rwr_codes["Vulcan"				] = { code = "VL", coal = 1, desc="VPS-2" }
...
rwr_codes["FPS-117 Dome"] = { code = "77", coal = 1, desc="Seek Igloo" }
rwr_codes["rapier_fsa_launcher"	] = { code = "RA", coal = 1, desc="Blindfire" }
rwr_codes["rapier_fsa_blindfire_radar"] = { code = "RA", coal = 1, desc="Blindfire" }
...
rwr_codes["MiG-29G"] = { code = "SB", coal = 2, desc = "N019 Slot Back" }
...
rwr_codes["HQ-7_LN_P"] = { code = "H7", coal = 2, desc="Type 345" }
...
rwr_codes["CH_HQ22_STR"	       	] = { code = "22", coal = 2, desc="Red Banner" }
rwr_codes["CH_HQ22_SR"	       	] = { code = "22", coal = 2, desc="Red Banner" }
rwr_codes["Type052D"	       	] = { code = "DD", coal = 2, desc="Dragon Eye" }
rwr_codes["CH_Type054B"	       	] = { code = "FF", coal = 2, desc="Front Dome" }
rwr_codes["CH_Type022"	       	] = { code = "22", coal = 2, desc="MR-36A" }
rwr_codes["Type055"	       		] = { code = "CG", coal = 2, desc="Type 346B" }
rwr_codes["CH_Type056A"	       	] = { code = "FS", coal = 2, desc="Type 349A" }
rwr_codes["PGL_625"	  	     	] = { code = "25", coal = 2, desc="PGL-625" }
rwr_codes["HQ17A"                            ] = { code = "17", coal = 2, desc = "AESA SA-15" }
...
rwr_codes["Karakurt_AShM"	    ] = { code = "FS", coal = 2, desc="Cross Round" } -- SA-N-22 Greyhound
rwr_codes["Karakurt_LACM"	    ] = { code = "FS", coal = 2, desc="Cross Round" } -- SA-N-22 Greyhound
...
rwr_codes["CH_S350_96L6"	    ] = { code = "28", coal = 2, desc="Cheese Board" }
rwr_codes["CH_S350_50N6"	    ] = { code = "28", coal = 2, desc="50N6E" }
rwr_codes["CH_Grigorovich_AShM"	] = { code = "FF", coal = 2, desc="Front Dome" } -- SA-N-12 Grizzly
rwr_codes["CH_Grigorovich_LACM"	] = { code = "FF", coal = 2, desc="Front Dome" } -- SA-N-12 Grizzly
rwr_codes["CH_Steregushchiy"	] = { code = "FS", coal = 2, desc="Furke-E" } -- SA-N-11b Grisom
rwr_codes["CH_Project22160"		] = { code = "CR", coal = 2, desc="Cross Round" }
rwr_codes["Admiral_Gorshkov"	] = { code = "FF", coal = 2, desc="Poliment" } -- SA-N-21d Growler

-- USA Assets by Currenthill --
rwr_codes["CH_Arleigh_Burke_III"	    ] = { code = "DD", coal = 1, desc="AN/SPY-6" }
rwr_codes["CH_Arleigh_Burke_IIA"	    ] = { code = "DD", coal = 1, desc="AN/SPY-1D" }
rwr_codes["CH_Ticonderoga"	   			] = { code = "CG", coal = 1, desc="AN/SPY-1B" }
rwr_codes["CH_Ticonderoga_CMP"	   		] = { code = "CG", coal = 1, desc="AN/SPY-1B" }
rwr_codes["CH_Constellation"			] = { code = "FF", coal = 1, desc="AN/SPY-6" }
rwr_codes["CH_NASAMS3_SR"	    		] = { code = "NS", coal = 1, desc="MPQ-64F1 Sentinel" }
rwr_codes["CH_Centurion_C_RAM"	    	] = { code = "CR", coal = 1, desc="VPS-2 Phalanx" }
...
--SA-12 (S-300V)
rwr_codes["S-300V 9S15 sr"						] = { code = "10", coal = 2, desc="Bill Board" }
rwr_codes["S-300V 9S19 sr"						] = { code = "10", coal = 2, desc="High Screen" }
rwr_codes["S-300V 9S32 tr"						] = { code = "10", coal = 2, desc="Grill Pan" }
rwr_codes["S-300V 9A82 ln"						] = { code = "10", coal = 2, desc="Grill Pan" }
rwr_codes["S-300V 9A83 ln"						] = { code = "10", coal = 2, desc="Grill Pan" }
...
--SA-23 (S-300VM)
rwr_codes["S-300VM 9S15M2 sr"					] = { code = "23", coal = 2, desc="Bill Board" }
rwr_codes["S-300VM 9S19M2 sr"					] = { code = "23", coal = 2, desc="High Screen" }
...
rwr_codes["S-300V4 9S19M-1E sr"					] = { code = "23", coal = 2, desc="High Screen" }
